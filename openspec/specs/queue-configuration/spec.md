...
- A toggle labelled "Maximum active downloads" bound to `download_queue_enabled` in the
  settings draft.
...
- A toggle labelled "Maximum active seeds" bound to `seed_queue_enabled` in the settings
  draft.
...
- **WHEN** the "Maximum active downloads" toggle is off
...
- **WHEN** the "Maximum active downloads" toggle is on
...
- **WHEN** the "Maximum active seeds" toggle is off
