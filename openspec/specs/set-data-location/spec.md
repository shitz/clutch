...
Define the "Set Data Location" feature: the context menu action, the modal dialog, and the
`torrent-set-location` RPC dispatch that lets users relocate a torrent's data directory on
